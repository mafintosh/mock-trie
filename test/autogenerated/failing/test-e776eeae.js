...
async function getObjects () {
  ...
  await op.put("b/cd/b","cqnlbvnrzi")
  await op.symlink("/d/dd","b/bb")

  return { actual, reference, state, tests: validators.tests }
}

function runTests () {
  test('iterator should not return unexpected key b/cd/b', async t => {
    ...
    try {
      ...
      t.fail(err, 'iterator should not return unexpected key b/cd/b')
    }
    t.end()
  })
}
...
// @FUZZ_SIGNATURE e776eeaed5481f38c270221aad77d1089637f4fa11e1e7ba3c7db8da414522f9
